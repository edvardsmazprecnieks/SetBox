...
@app.route('/return-subject')
def home():
    return redirect(url_for('subject', subject_id='my-variable'))
...
def lesson(lesson_id):
    ...
    cursor = connection.cursor()
    cursor.execute(
        "SELECT subjects.name, lesson.name, TO_CHAR(lesson.date, 'dd.mm.yyyy') FROM subjects " +
